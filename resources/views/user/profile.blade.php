    ...
    <div class="max-w-5xl mx-auto bg-[#E0F2FE] rounded-[40px] shadow-xl overflow-hidden mb-16 animate-fade-in-up">
        ...
        <div
            ...
            <div class="w-24 h-24 md:w-40 md:h-40 rounded-full bg-white p-2 shadow-lg relative group">
                ...
                : 'https://ui-avatars.com/api/?name='.urlencode(Auth::user()->name).'&background=294C60&color=fff&size=256';
                @endphp
                <img src="{{ $photoUrl }}" alt="Avatar" class="w-full h-full rounded-full object-cover border-4 border-[#E0F2FE]">
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-y-6 md:gap-y-8 gap-x-6 md:gap-x-12">
                ...
                <div class="space-y-5">
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <p class="text-xs text-slate-500 uppercase font-bold tracking-wider">Username</p>
                            <p class="text-base md:text-lg font-semibold text-[#294C60]">{{Auth::user()->username}}</p>
                        </div>
                    </div>
