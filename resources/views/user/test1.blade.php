...
@section('content')
    ...
    --}}
    <section class="container mx-auto px-4 md:px-0 flex flex-col justify-center items-center"
        ...
        <div
            ...
            <div
                ...
                <img src="{{ asset('assets/img/illustrations/ilustrasi_v2.png') }}" alt="Brain Illustration"
                    class="w-32 md:w-56 mb-6 drop-shadow-xl relative z-10 hover:scale-105 transition-transform duration-500">
