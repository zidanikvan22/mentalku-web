        ...
        <div
            ...
            <div class="flex flex-row flex-grow overflow-hidden">
                ...
                <div class="w-full lg:w-3/5 p-6 md:p-8 flex flex-col h-full bg-white">
                    ...
                    <form action="#" method="POST" class="flex-grow flex flex-col min-h-0">
                        @csrf

                        {{-- Textarea Container: Flex Grow mengisi sisa ruang --}}
                        <div class="relative flex-grow mb-4 group">
                            <textarea
                                ...
                                placeholder="Mulai menulis di sini...&#10;Contoh: 'Hari ini rasanya berat sekali karena...'"></textarea>
                        </div>
